...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__helpers_http__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_Board__ = __webpack_require__(34);
...
var Trello = function () {
    ...
    function Trello(config) {
        ...
        var errors = validateConfig(this._config);
        if (errors.length > 0) {
            throw new Error('Failed to build Trello Client:\n\t' + errors.join('\n\t'));
        }

        if (this._config.boards) {
            this._boards = _extends({}, this._config.boards);
        }
        ...
        if (this._config.responseTransformer) {
            __WEBPACK_IMPORTED_MODULE_0__helpers_http__["b" /* trelloAxios */].interceptors.response.use(this._config.responseTransformer, function (error) {
        ...
        if (!this._config.removeCsrfHeaders) {
            __WEBPACK_IMPORTED_MODULE_0__helpers_http__["b" /* trelloAxios */].interceptors.request.eject(__WEBPACK_IMPORTED_MODULE_0__helpers_http__["c" /* trelloCSRFRequestInterceptor */]);
        }
    }
    ...
    _createClass(Trello, [{
        key: 'board',
        value: function board(nameOrId) {
            // Check if there are any presets with that key name, if not, it should be a pure id
            if (!this._boards[nameOrId]) {
                this._board = new __WEBPACK_IMPORTED_MODULE_1__api_Board__["a" /* default */](this, nameOrId);
            }

            // We found a preset with the named key. Create a new instance of Board unless 
            // it's already set
            if (!this._board) {
                this._board = new __WEBPACK_IMPORTED_MODULE_1__api_Board__["a" /* default */](this, this._boards[nameOrId]);
            } else {
        ...
        value: function addBoard(board) {
            this._boards = _extends({}, this._boards, board);
        }
        ...
        value: function get(uri) {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_0__helpers_http__["a" /* makeRequest */])('get', uri, this._config, data);
        }
    }, {
        key: 'delete',
        value: function _delete(uri) {
            return Object(__WEBPACK_IMPORTED_MODULE_0__helpers_http__["a" /* makeRequest */])('delete', uri, this._config);
        }
    }, {
        key: 'post',
        value: function post(uri, data) {
            return Object(__WEBPACK_IMPORTED_MODULE_0__helpers_http__["a" /* makeRequest */])('post', uri, this._config, data);
        }
    }, {
        key: 'put',
        value: function put(uri, data) {
            return Object(__WEBPACK_IMPORTED_MODULE_0__helpers_http__["a" /* makeRequest */])('put', uri, this._config, data);
        }
    }, {
        key: 'boards',
        get: function get() {
            if (!this._board) {
                this._board = new __WEBPACK_IMPORTED_MODULE_1__api_Board__["a" /* default */](this);
            }
...
/* harmony default export */ __webpack_exports__["default"] = (Trello);
...
const strictUriEncode = __webpack_require__(32);
const decodeComponent = __webpack_require__(33);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Trello__ = __webpack_require__(2);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var AbstractApiResource = function () {
    function AbstractApiResource(client, id) {
        var uri = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';

        _classCallCheck(this, AbstractApiResource);
        ...
        if (!client || !(client instanceof __WEBPACK_IMPORTED_MODULE_0__Trello__["default"])) {
            throw new TypeError('');
        }
    ...
    _createClass(AbstractApiResource, [{
        key: 'byId',
        ...
        key: 'setAndValidateParams',
        value: function setAndValidateParams(params) {}
        ...
        key: 'validateRequiredParams',
        value: function validateRequiredParams(params) {
            ...
            if (!this._required.length) {
                ...
                this._required.forEach(function (el) {
                    if (!params[el]) {
...
/* harmony default export */ __webpack_exports__["a"] = (AbstractApiResource);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return trelloAxios; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return trelloCSRFRequestInterceptor; });
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var trelloAxios = __webpack_require__(12).create();
 ...
 */
var trelloCSRFRequestInterceptor = trelloAxios.interceptors.request.use(function (config) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AbstractApiResource__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Board_Cards__ = __webpack_require__(35);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Board = function (_AbstractApiResource) {
    _inherits(Board, _AbstractApiResource);
    ...
    function Board(client) {
        ...
        var _this = _possibleConstructorReturn(this, (Board.__proto__ || Object.getPrototypeOf(Board)).call(this, client, id, 'boards'));

        _this._required = ['name'];
        _this._fields = ['name', 'desc', 'descData', 'closed', 'idOrganization', 'pinned', 'url', 'shortUrl', 'prefs', 'labelNames', 'starred', 'limits', 'memberships'];
        return _this;
    }
    ...
    _createClass(Board, [{
        ...
        get: function get() {
            if (!this._cards) {
                this._cards = new __WEBPACK_IMPORTED_MODULE_1__Board_Cards__["a" /* default */](this._client, this._resourceId);
            }
    ...
    return Board;
}(__WEBPACK_IMPORTED_MODULE_0__AbstractApiResource__["a" /* default */]);
...
var Cards = function (_AbstractApiResource) {
    _inherits(Cards, _AbstractApiResource);
    ...
    function Cards(client) {
        ...
        var _this = _possibleConstructorReturn(this, (Cards.__proto__ || Object.getPrototypeOf(Cards)).call(this, client, id, 'boards/' + id + '/cards'));
